from db.models import BotInstance, PrestigeStatistics, Prestige

import eel


@eel.expose
def prestiges_information(selected_instance=None):
    """
    ...
    if selected_instance:
        ...
        return {
            "pk": instance.pk,
            "name": instance.name,
            "prestiges": PrestigeStatistics.objects.grab(instance=instance).json()
        }
