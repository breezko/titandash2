...
GAME_IMAGES = {
    ...
    "master": {
        ...
        "master_intimidating_presence": BOT_IMAGE_DIR + "/master/master_intimidating_presence.png",
    },
    "no_panels": {
...
ARTIFACT_TIER_MAP = {
    "S": {
        "book_of_shadows": (ARTIFACT_IMAGE_DIR + "/artifacts/book_of_shadows.png", 22),
        "stone_of_the_valrunes": (ARTIFACT_IMAGE_DIR + "/artifacts/stone_of_the_valrunes.png", 2),
        "flute_of_the_soloist": (ARTIFACT_IMAGE_DIR + "/artifacts/flute_of_the_soloist.png", 84),
        "heart_of_storms": (ARTIFACT_IMAGE_DIR + "/artifacts/heart_of_storms.png", 52),
        "ring_of_calisto": (ARTIFACT_IMAGE_DIR + "/artifacts/ring_of_calisto.png", 40),
        "invaders_gjalarhorn": (ARTIFACT_IMAGE_DIR + "/artifacts/invaders_gjalarhorn.png", 47),
        "boots_of_hermes": (ARTIFACT_IMAGE_DIR + "/artifacts/boots_of_hermes.png", 70),
    },
    "A": {
        "charged_card": (ARTIFACT_IMAGE_DIR + "/artifacts/charged_card.png", 95),
        "book_of_prophecy": (ARTIFACT_IMAGE_DIR + "/artifacts/book_of_prophecy.png", 20),
        "khrysos_bowl": (ARTIFACT_IMAGE_DIR + "/artifacts/khrysos_bowl.png", 66),
        "the_bronzed_compass": (ARTIFACT_IMAGE_DIR + "/artifacts/the_bronzed_compass.png", 82),
        "evergrowing_stack": (ARTIFACT_IMAGE_DIR + "/artifacts/evergrowing_stack.png", 94),
        "heavenly_sword": (ARTIFACT_IMAGE_DIR + "/artifacts/heavenly_sword.png", 26),
        "divine_retribution": (ARTIFACT_IMAGE_DIR + "/artifacts/divine_retribution.png", 31),
        "drunken_hammer": (ARTIFACT_IMAGE_DIR + "/artifacts/drunken_hammer.png", 29),
        "samosek_sword": (ARTIFACT_IMAGE_DIR + "/artifacts/samosek_sword.png", 51),
        "the_retaliator": (ARTIFACT_IMAGE_DIR + "/artifacts/the_retaliator.png", 59),
        "stryfe's_peace": (ARTIFACT_IMAGE_DIR + "/artifacts/stryfes_peace.png", 83),
        "hero's_blade": (ARTIFACT_IMAGE_DIR + "/artifacts/heros_blade.png", 35),
        "the_sword_of_storms": (ARTIFACT_IMAGE_DIR + "/artifacts/the_sword_of_storms.png", 32),
        "furies_bow": (ARTIFACT_IMAGE_DIR + "/artifacts/furies_bow.png", 33),
        "charm_of_the_ancient": (ARTIFACT_IMAGE_DIR + "/artifacts/charm_of_the_ancient.png", 34),
        "tiny_titan_tree": (ARTIFACT_IMAGE_DIR + "/artifacts/tiny_titan_tree.png", 61),
        "helm_of_hermes": (ARTIFACT_IMAGE_DIR + "/artifacts/helm_of_hermes.png", 62),
        "o'ryans_charm": (ARTIFACT_IMAGE_DIR + "/artifacts/oryans_charm.png", 64),
        "apollo_orb": (ARTIFACT_IMAGE_DIR + "/artifacts/apollo_orb.png", 53),
        "earrings_of_portara": (ARTIFACT_IMAGE_DIR + "/artifacts/earrings_of_portara.png", 67),
        "helheim_skull": (ARTIFACT_IMAGE_DIR + "/artifacts/helheim_skull.png", 56),
        "oath's_burden": (ARTIFACT_IMAGE_DIR + "/artifacts/oaths_burden.png", 75),
        "crown_of_the_constellation": (ARTIFACT_IMAGE_DIR + "/artifacts/crown_of_the_constellation.png", 76),
        "titania's_sceptre": (ARTIFACT_IMAGE_DIR + "/artifacts/titanias_sceptre.png", 77),
        "blade_of_damocles": (ARTIFACT_IMAGE_DIR + "/artifacts/blade_of_damocles.png", 25),
        "helmet_of_madness": (ARTIFACT_IMAGE_DIR + "/artifacts/helmet_of_madness.png", 17),
        "titanium_plating": (ARTIFACT_IMAGE_DIR + "/artifacts/titanium_plating.png", 23),
        "moonlight_bracelet": (ARTIFACT_IMAGE_DIR + "/artifacts/moonlight_bracelet.png", 73),
        "amethyst_staff": (ARTIFACT_IMAGE_DIR + "/artifacts/amethyst_staff.png", 28),
        "spearit's_vigil": (ARTIFACT_IMAGE_DIR + "/artifacts/spearits_vigil.png", 87),
        "sword_of_the_royals": (ARTIFACT_IMAGE_DIR + "/artifacts/sword_of_the_royals.png", 86),
        "the_cobalt_plate": (ARTIFACT_IMAGE_DIR + "/artifacts/the_cobalt_plate.png", 88),
        "sigils_of_judgement": (ARTIFACT_IMAGE_DIR + "/artifacts/sigils_of_judgement.png", 89),
        "foilage_of_the_keeper": (ARTIFACT_IMAGE_DIR + "/artifacts/foilage_of_the_keeper.png", 90),
        "laborer's_pendant": (ARTIFACT_IMAGE_DIR + "/artifacts/laborers_pendant.png", 9),
        "bringer_of_ragnarok": (ARTIFACT_IMAGE_DIR + "/artifacts/bringer_of_ragnarok.png", 10),
        "parchment_of_foresight": (ARTIFACT_IMAGE_DIR + "/artifacts/parchment_of_foresight.png", 7),
        "unbound_gauntlet": (ARTIFACT_IMAGE_DIR + "/artifacts/unbound_gauntlet.png", 74),
        "lucky_foot_of_al-mi-raj": (ARTIFACT_IMAGE_DIR + "/artifacts/lucky_foot_of_al-mi-raj.png", 69),
        "morgelai_sword": (ARTIFACT_IMAGE_DIR + "/artifacts/morgelai_sword.png", 71),
        "ringing_stone": (ARTIFACT_IMAGE_DIR + "/artifacts/ringing_stone.png", 91),
        "quill_of_scrolls": (ARTIFACT_IMAGE_DIR + "/artifacts/quill_of_scrolls.png", 92),
        "old_king's_stamp": (ARTIFACT_IMAGE_DIR + "/artifacts/old_kings_stamp.png", 93),
        "the_magnifier": (ARTIFACT_IMAGE_DIR + "/artifacts/the_magnifier.png", 80),
        "the_treasure_of_fergus": (ARTIFACT_IMAGE_DIR + "/artifacts/the_treasure_of_fergus.png", 81),
        "the_white_dwarf": (ARTIFACT_IMAGE_DIR + "/artifacts/the_white_dwarf.png", 85),
    },
    "B": {
        "chest_of_contentment": (ARTIFACT_IMAGE_DIR + "/artifacts/chest_of_contentment.png", 19),
        "heroic_shield": (ARTIFACT_IMAGE_DIR + "/artifacts/heroic_shield.png", 1),
        "zakynthos_coin": (ARTIFACT_IMAGE_DIR + "/artifacts/zakynthos_coin.png", 43),
        "great_fay_medallion": (ARTIFACT_IMAGE_DIR + "/artifacts/great_fay_medallion.png", 44),
        "neko_sculpture": (ARTIFACT_IMAGE_DIR + "/artifacts/neko_sculpture.png", 45),
        "coins_of_ebizu": (ARTIFACT_IMAGE_DIR + "/artifacts/coins_of_ebizu.png", 79),
        "fruit_of_eden": (ARTIFACT_IMAGE_DIR + "/artifacts/fruit_of_eden.png", 38),
        "influential_elixir": (ARTIFACT_IMAGE_DIR + "/artifacts/influential_elixir.png", 30),
        "avian_feather": (ARTIFACT_IMAGE_DIR + "/artifacts/avian_feather.png", 42),
        "fagin's_grip": (ARTIFACT_IMAGE_DIR + "/artifacts/fagins_grip.png", 78),
        "titan's_mask": (ARTIFACT_IMAGE_DIR + "/artifacts/titans_mask.png", 11),
        "royal_toxin": (ARTIFACT_IMAGE_DIR + "/artifacts/royal_toxin.png", 41),
        "elixir_of_eden": (ARTIFACT_IMAGE_DIR + "/artifacts/elixir_of_eden.png", 6),
        "hourglass_of_the_impatient": (ARTIFACT_IMAGE_DIR + "/artifacts/hourglass_of_the_impatient.png", 65),
        "phantom_timepiece": (ARTIFACT_IMAGE_DIR + "/artifacts/phantom_timepiece.png", 48),
        "infinity_pendulum": (ARTIFACT_IMAGE_DIR + "/artifacts/infinity_pendulum.png", 36),
        "glove_of_kuma": (ARTIFACT_IMAGE_DIR + "/artifacts/glove_of_kuma.png", 27),
        "titan_spear": (ARTIFACT_IMAGE_DIR + "/artifacts/titan_spear.png", 39),
        "oak_staff": (ARTIFACT_IMAGE_DIR + "/artifacts/oak_staff.png", 37),
        "the_arcana_cloak": (ARTIFACT_IMAGE_DIR + "/artifacts/the_arcana_cloak.png", 3),
        "hunter's_ointment": (ARTIFACT_IMAGE_DIR + "/artifacts/hunters_ointment.png", 8),
        "axe_of_muerte": (ARTIFACT_IMAGE_DIR + "/artifacts/axe_of_muerte.png", 4),
        "the_master's_sword": (ARTIFACT_IMAGE_DIR + "/artifacts/the_masters_sword.png", 49),
        "mystical_beans_of_senzu": (ARTIFACT_IMAGE_DIR + "/artifacts/mystical_beans_of_senzu.png", 68),
    },
    "C": {
        "corrupted_rune_heart": (ARTIFACT_IMAGE_DIR + "/artifacts/corrupted_rune_heart.png", 46),
        "durendal_sword": (ARTIFACT_IMAGE_DIR + "/artifacts/durendal_sword.png", 55),
        "forbidden_scroll": (ARTIFACT_IMAGE_DIR + "/artifacts/forbidden_scroll.png", 13),
        "ring_of_fealty": (ARTIFACT_IMAGE_DIR + "/artifacts/ring_of_fealty.png", 15),
        "glacial_axe": (ARTIFACT_IMAGE_DIR + "/artifacts/glacial_axe.png", 16),
        "aegis": (ARTIFACT_IMAGE_DIR + "/artifacts/aegis.png", 14),
        "swamp_gauntlet": (ARTIFACT_IMAGE_DIR + "/artifacts/swamp_gauntlet.png", 12),
        "ambrosia_elixir": (ARTIFACT_IMAGE_DIR + "/artifacts/ambrosia_elixir.png", 50),
        "mystic_staff": (ARTIFACT_IMAGE_DIR + "/artifacts/mystic_staff.png", 58),
        "egg_of_fortune": (ARTIFACT_IMAGE_DIR + "/artifacts/egg_of_fortune.png", 18),
        "divine_chalice": (ARTIFACT_IMAGE_DIR + "/artifacts/divine_chalice.png", 21),
        "invader's_shield": (ARTIFACT_IMAGE_DIR + "/artifacts/invaders_shield.png", 5),
        "essence_of_kitsune": (ARTIFACT_IMAGE_DIR + "/artifacts/essence_of_kitsune.png", 54),
        "oberon_pendant": (ARTIFACT_IMAGE_DIR + "/artifacts/oberon_pendant.png", 72),
        "lost_king's_mask": (ARTIFACT_IMAGE_DIR + "/artifacts/lost_kings_mask.png", 63),
        "staff_of_radiance": (ARTIFACT_IMAGE_DIR + "/artifacts/staff_of_radiance.png", 24),
        "aram_spear": (ARTIFACT_IMAGE_DIR + "/artifacts/aram_spear.png", 57),
        "ward_of_the_darkness": (ARTIFACT_IMAGE_DIR + "/artifacts/ward_of_the_darkness.png", 60),
    },
}
